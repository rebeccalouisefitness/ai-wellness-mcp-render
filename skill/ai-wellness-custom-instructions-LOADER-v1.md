...
2. **Use master.md as the source of truth for step content.** Suggested phrasing comes from master.md — adapt naturally for tone, but keep the flow's structure and tool-call sequence intact.
